...
public class retailprice  {
	...
	static String paymentMode="display";//Credit Card,App Store Billing//ApplePay
...
if (promotionsResponseMessageArrayNode.isEmpty()) {
	...
	System.out.println("test3");
        ...
        for(int i = 0;i<promotionsResponseMessageArrayNode.size();i++) {
             ...
             if (skuapi.equals("\""
             	...
             	String vip1m = sku.get("retailPrice").toString().replace(".0", "");
             	String vipcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
             ...
             if (skuapi.equals("\""
              	 ...
              	 sku=promotionObjectNode;
              	String vip12m = sku.get("retailPrice").toString().replace(".0", "");
                String vip12mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
             ...
             if (skuapi.equals("\""
               	 ...
               	 sku=promotionObjectNode;
               	String gea1m = sku.get("retailPrice").toString().replace(".0", "");
                 String gea1mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
             ...
             if (skuapi.equals("\""
                	 ...
                	 sku=promotionObjectNode;
                	String gea12m = sku.get("retailPrice").toString().replace(".0", "");
                	String gea12mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
             ...
             if (skuapi.equals("\""
                	 ...
                	 sku=promotionObjectNode;
                	String sport1m = sku.get("retailPrice").toString().replace(".0", "");
                     String sport1mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
              ...
              if (skuapi.equals("\""
                 	 ...
                 	 sku=promotionObjectNode;
                 	String sport12m = sku.get("retailPrice").toString().replace(".0", "");
                    String sport12mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
              ...
              if (skuapi.equals("\""
                   	 ...
                   	 sku=promotionObjectNode;
                   	String ultimate1m = sku.get("retailPrice").toString().replace(".0", "");
                     String ultimate1mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
              ...
              if (skuapi.equals("\""
                 	 ...
                 	 sku=promotionObjectNode;
                 	String ultimate12m = sku.get("retailPrice").toString().replace(".0", "");
                   String ultimate12mcurrency = sku.get("retailCurrency").toString().replace("\"", "");;
	...
	public static String[][] Country()throws Exception   {
		Reader reader = new FileReader("/Users/admin/Documents/pricetest/display.csv");
